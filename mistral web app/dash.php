...
<div class="nav1 " >
    <button onclick="homefunc()" class="btn" id="home">
            ...
            <ul class="list">
               <li> <a href="#" onclick="slideOpen()">
                    <i class="fa fa-bars" id="bars"></i>
                </a></li>
          <li>  <h1 id="main">Nellai Neervalam</h1></li>
           <li style="float:right"> <a href="login.html">
                    <i class="fa fa-power-off" id="bars"></i></li>
...
<div style="padding-bottom:100px"><img src="pi.png" alt="close" class="close" onclick="popclose()">  </div>         
 <div style="float:left;padding-left:18px;padding-right:14px"><button class="drop btn1" onclick="createfunc()"> <i class="fa fa-user-plus" style="font-size:12px"></i>&nbsp;Create User</button></div>
<div style="float:left">           
<button class="drop btn1"  onclick="addfunc()"><i class="fa fa-plus" style="font-size:12px"></i>&nbsp;&nbsp;Add Location/Sensor</button>
     </div>       
</div>
